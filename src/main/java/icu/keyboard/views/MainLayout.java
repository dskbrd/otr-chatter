...
import icu.keyboard.views.home.HomeView;
import icu.keyboard.views.rooms.RoomsView;
import icu.keyboard.views.login.LoginView;
import com.vaadin.flow.component.avatar.Avatar;
import icu.keyboard.data.entity.User;
import icu.keyboard.security.AuthenticatedUser;
...
public class MainLayout extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "otr-chatter logo"));
        logoLayout.add(new H1("otr-chatter"));
    ...
    private List<Tab> createMenuItems() {
        MenuItemInfo[] menuItems = new MenuItemInfo[]{ //
                ...
                new MenuItemInfo("Rooms", "la la-globe", RoomsView.class), //
